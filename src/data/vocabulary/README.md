...
读音音频存放在 R2 bucket `english-orbit`，公开域名为 `https://assets.english.ifcalm.org`。
读音资产路径、来源字段和读取方式见 `/Users/lishuaishuai/Projects/githubProjects/language/docs/pronunciation-assets.md`。
当前 Top 100 已生成 US / UK 两组 bootstrap 音频，并写入 `vocabulary_pronunciations`。
